...
Authors: David Fisher and Jacob Back, Craig McGee II, Chris Fusaro.
...
def follow_the_line(robot, white_level, black_level):
    ...
    while True:
        if robot.color_sensor.reflected_light_intensity > black_level - 5 and robot.color_sensor.reflected_light_intensity < black_level + 5:
            robot.forward(200, 200)
        else:
            #robot.left_forward(500)
            robot.right_turn(500,200)
